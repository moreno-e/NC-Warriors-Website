const data = [
  ...
  },
  {
    ...
    bio:
      "*Player Spotlight* #40 Shawn Hanrahan from Unadilla, NY. Shawn served for four years in the US Marine Corps as a 6531 Aviation Ordnance Technician and has been playing hockey for about 5 years now with no plans of stopping anytime soon! "},
  {
    name: "Matt Mason",
    image: "../PlayerImages/Mason.jpg",
    bio:
