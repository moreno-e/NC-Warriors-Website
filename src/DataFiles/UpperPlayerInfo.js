const data = [
  ...
  {
    name: 'Greg Walters',
    image: '../PlayerImages/G.Walters.jpg',
    bio:
      'Gregory is from Johnstown, PA and has been playing hockey for the past 18 years, being a part of the NC Warriors since its inception. Greg served in the Marine Corps as a Vehicle Recovery Operator part of 2nd Maintenance Battalion, Camp Lejeune, NC, with a deployment to Afghanistan. Greg has been playing competitive hockey since junior high school, high school and travel hockey 2A.',
  },
  {
    name: 'Matt Mason',
