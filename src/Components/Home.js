                ...
                <div className={classes.root} >          
                    <Grid container spacing={10}>
                        <Grid item xs={6} style={{marginTop: 50}}>
                                ...
                                <Typography className={classes.typography} variant="h2" style={{fontSize: 25}}>
                                    Est. 2019 Raleigh, N.C.
                                </Typography>
                                <p >
                                    The North Carolina Warriors Ice Hockey Program is a disabled 
                                    veterans ice hockey team that exists to benefit disabled veterans 
                                    from the United States Military Services. They are one of 21 USA 
                                    Hockey Warriors teams in the nation. 
                                </p>
                                <p>
                                    Each and every one of these 
                                    teams exist with the focus of providing an athletic outlet, with 
                                    a sense of therapy and comradery for it’s members. The team 
                                    consists of veterans that have service rated disabilities that 
                                    can, and do, include physical disabilities that include surgically 
                                    rebuilt limbs, non-fully functional appendages, and other physical 
                                    challenges that have become the players new norm. 
                                </p>
                                <p>
                                    This however, does 
                                    not, and will not keep the Warriors from enjoying the game they love. 
                                    These hockey players on the North Carolina Warriors Ice Hockey team 
                                    roster ranges from having played for many years to veteran’s who are 
                                    interested in trying hockey for the first time and this range evokes
                                    the training and teamwork that these Veterans value so much.
                                </p>
                                <p className={classes.p2}>
                                    ...
                                    together and you have something more intimate and fraternal.”
                                </p>
                                <p >
                        ...
                        This Weeks Player Spot Light!                        
                            ...
                            <Card>
                                <CardContent>
                                    <img  src={Benner} height="540px" width="540px"/>
                                </CardContent>
                            </Card>                                                                  
                        </Grid>
